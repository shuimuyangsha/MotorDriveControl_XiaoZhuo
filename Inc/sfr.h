...
#define Enable485TX()  do{COM485_UART->CR1 &= (~UART_IT_RXNE); HAL_GPIO_WritePin(TX_485_EN_GPIO_Port,TX_485_EN_Pin,  GPIO_PIN_SET); COM485_UART->CR1 |= USART_CR1_TE; COM485_UART->CR1 &= ~USART_CR1_RE;}while(0)
#define Disable485TX()  do{HAL_GPIO_WritePin(TX_485_EN_GPIO_Port,TX_485_EN_Pin,  GPIO_PIN_RESET);COM485_UART->CR1 |= USART_CR1_RE; COM485_UART->CR1 &= ~USART_CR1_TE;COM485_UART->CR1 |= UART_IT_RXNE;}while(0)
